...
static constexpr gpio_num_t sensorPins[numPlants] {GPIO_NUM_36, GPIO_NUM_39, GPIO_NUM_34, GPIO_NUM_35, GPIO_NUM_32, GPIO_NUM_33};
/*
...
void updateSensorVarsOnMemory(){
	Serial.println("Updating all sensor readings on memory");
	preferences.begin(variablesNamespace.c_str(), false);
